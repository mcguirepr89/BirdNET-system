...
#### Checkout the newer, better version [(HERE)](https://github.com/mcguirepr89/BirdNET-Pi) based on the [TFLite version of BirdNET](https://github.com/kahst/BirdNET-Lite)
.
